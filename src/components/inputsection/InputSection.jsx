  ...
  return (
    <div className='input_container'>
       ...
       <div className='emoji_container'>
         ...
         { emojiContainer && <div className='emoji_window'>< EmojiPicker height={300} width={300} previewConfig={{showPreview:false}} onEmojiClick={handleEmojiClick}/></div>}
          <SentimentSatisfiedAltIcon className='emoji_button' onClick={handleEmojiContainer}/>
