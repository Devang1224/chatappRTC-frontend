...
console.log("not rendering");
  ...
  return (<>
    <div className={`left_container ${openMenu?"show_left_container":"hide_left_container"}`}>
      <Topbar/>
      <Search/>
      <Convos/>

      <div className="menu_container" onClick={handleOpenMenu}>
        {openMenu?<KeyboardDoubleArrowRightIcon className='menu_icon'/>:<KeyboardDoubleArrowLeftIcon className='menu_icon'/>}
      </div>
